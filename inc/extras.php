...
add_filter( 'body_class', 'adventure_body_classes' );

/**
 * Filter in a link to a content ID attribute for the next/previous image links on image attachment pages
 */
function adventure_enhanced_image_navigation( $url, $id ) {
...
add_filter( 'attachment_link', 'adventure_enhanced_image_navigation', 10, 2 );
